            ...
            <div className="container mx-auto px-4 lg:px-8 py-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <aside className="w-full lg:w-72 flex-shrink-0">
                        ...
                        {/* Desktop Sidebar */}
                        <div className="sticky top-20 h-[calc(100vh-6rem)] overflow-y-auto pr-2 hidden lg:block space-y-8 pb-4">
                            ...
                            <div>
                                ...
                                <ul className="menu bg-white rounded-xl shadow-sm border border-slate-200 w-full text-sm font-medium">
                                    ...
                                    <li>
                                        {/* Link Aktif (Simulasi halaman Cara Kerja) */}
                        ...
                        <div className="lg:hidden mb-8">
                            <div className="collapse collapse-arrow bg-base-100 shadow-sm border border-slate-200">
                                ...
                                <div className="collapse-title font-medium text-sm py-4 flex items-center justify-between">
                                    <span>Daftar Isi Dokumentasi</span>
                                </div>
                                <div className="collapse-content text-sm bg-white border-t border-slate-100">
                                    <ul className="menu w-full">
                                        <li><Link href="#" className="active">Cara Kerja</Link></li>
                    ...
                    <main className="flex-1 min-w-0">
                        <article className="bg-white p-6 md:p-12 rounded-2xl shadow-sm border border-slate-200">
                            ...
                            <div className="border-b border-slate-100 pb-8 mb-8">
                                <span className="badge badge-secondary badge-outline p-3 mb-4">Cara Kerja</span>
                                <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4 tracking-tight">
                                    Cara Kerja Sistem BroilerSmart
                                </h1>
  ...
  "status": "normal"
                            ...
                            <div className="mt-16 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
                                ...
                                <Link href="/docs/install" className="btn btn-sm btn-primary w-full md:w-auto justify-end">
                                    Instalasi Hardware <FaChevronRight />
                                </Link>
                            </div>
